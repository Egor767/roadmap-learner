...
down_revision: str | Sequence[str] | None = "d15bbc5f3fc3"
...
def upgrade() -> None:
    ...
    op.create_foreign_key(op.f("fk_blocks_user_id_users"), "blocks", "users", ["user_id"], ["id"], ondelete="CASCADE")
    ...
    op.create_foreign_key(op.f("fk_cards_user_id_users"), "cards", "users", ["user_id"], ["id"], ondelete="CASCADE")
...
def downgrade() -> None:
    ...
    op.create_foreign_key(op.f("fk_sessions_roadmap_id_roadmaps"), "sessions", "roadmaps", ["roadmap_id"], ["id"])
    op.drop_constraint(op.f("fk_roadmaps_user_id_users"), "roadmaps", type_="foreignkey")
    op.create_foreign_key(op.f("fk_roadmaps_user_id_users"), "roadmaps", "users", ["user_id"], ["id"])
    op.drop_constraint(op.f("fk_cards_user_id_users"), "cards", type_="foreignkey")
    op.drop_constraint(op.f("fk_cards_block_id_blocks"), "cards", type_="foreignkey")
    op.create_foreign_key(op.f("fk_cards_block_id_blocks"), "cards", "blocks", ["block_id"], ["id"])
    op.drop_column("cards", "user_id")
    op.drop_constraint(op.f("fk_blocks_user_id_users"), "blocks", type_="foreignkey")
    op.drop_constraint(op.f("fk_blocks_roadmap_id_roadmaps"), "blocks", type_="foreignkey")
    op.create_foreign_key(op.f("fk_blocks_roadmap_id_roadmaps"), "blocks", "roadmaps", ["roadmap_id"], ["id"])
    op.drop_column("blocks", "user_id")
    op.drop_constraint(op.f("fk_access_tokens_user_id_users"), "access_tokens", type_="foreignkey")
    op.create_foreign_key(op.f("fk_access_tokens_user_id_users"), "access_tokens", "users", ["user_id"], ["id"])
    # ### end Alembic commands ###
