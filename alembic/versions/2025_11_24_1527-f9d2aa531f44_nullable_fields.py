...
down_revision: str | Sequence[str] | None = "5fcbe25ded91"
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("roadmaps", "description", existing_type=sa.VARCHAR(length=100), nullable=False)
    op.alter_column(
        "cards",
        "comment",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["roadmap_id"], ["roadmaps.id"], name=op.f("sessions_roadmap_id_fkey")),
